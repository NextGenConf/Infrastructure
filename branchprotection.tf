resource "github_branch_protection" "branch_protection_conference_service" {
  repository     = github_repository.repository_conference_service.name
  branch         = "master"
  enforce_admins = true
...
resource "github_branch_protection" "branch_protection_web_app" {
  repository     = github_repository.repository_web_app.name
  branch         = "master"
  enforce_admins = true
